                ...
                for (var i = 0; i < commandList.Count; i++)
                {
                    switch (commandList[i].Type)
                    {
                        ...
                        case EventCommandType.ClassChangeWindow:
                            var ccw = (ClassChangeWindowCommand)commandList[i];
                            lstEventCommands.Items.Add(
                                indent +
                                Strings.EventCommandList.linestart +
                                GetCommandText((dynamic)commandList[i], map)
                            ...
                            for (var x = 0; x < 4; x++)
                            {
                                if (ccw.Options[x] == null)
                                {
                                    continue;
                                }
                                if (ccw.Options[x].Trim().Length <= 0)
                                {
                                    continue;
                                }
                                ...
                                lstEventCommands.Items.Add(
                                    indent +
                                    "      : " +
                                    Strings.EventCommandList.whenoption.ToString(Truncate(ClassBase.GetName(Guid.Parse(ccw.Options[x])), 20))
                                );
                                ...
                                mCommandProperties.Add(clp);
                                PrintCommandList(
                                    page, page.CommandLists[ccw.BranchIds[x]], indent + "          ", lstEventCommands,
                                    mCommandProperties, map
                                );
                            }
