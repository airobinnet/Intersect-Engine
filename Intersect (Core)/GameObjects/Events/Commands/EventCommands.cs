...
namespace Intersect.GameObjects.Events.Commands
{
    ...
    public class ItemChoiceWindowCommand : EventCommand
    {

        //For Json Deserialization
        public ItemChoiceWindowCommand()
        {
        }

        public ItemChoiceWindowCommand(Dictionary<Guid, List<EventCommand>> commandLists)
        {
            for (var i = 0; i < BranchIds.Length; i++)
            {
                BranchIds[i] = Guid.NewGuid();
        ...
        public override EventCommandType Type { get; } = EventCommandType.ItemChoiceWindow;
    ...
    public class ClassChangeWindowCommand : EventCommand
    {

        //For Json Deserialization
        public ClassChangeWindowCommand()
        {
        }

        public ClassChangeWindowCommand(Dictionary<Guid, List<EventCommand>> commandLists)
        {
            for (var i = 0; i < BranchIds.Length; i++)
            {
                BranchIds[i] = Guid.NewGuid();
        ...
        public override EventCommandType Type { get; } = EventCommandType.ClassChangeWindow;
